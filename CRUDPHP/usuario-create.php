    ...
    <div class="card-body">
      <form method="POST" action="acoes.php" autocomplete="off" class="row g-3">
        <div class="col-md-6">
          ...
          <input type="text" name="nome" id="nome" class="form-control" maxlength="120" required>
        </div>
        <div class="col-md-6">
          <label for="email" class="form-label">E-mail <span class="text-danger">*</span></label>
          <input type="email" name="email" id="email" class="form-control" maxlength="120" required>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-12 mt-3">
          <button type="submit" name="criar_usuario" class="btn btn-primary ripple">
...
document.addEventListener('DOMContentLoaded', function () {
  // Fade-in animado no card de cadastro
